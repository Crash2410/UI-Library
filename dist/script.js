...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    let offset = 0;
    let slideIndex = 0; // Переключение вперед
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i].querySelector('[data-slide="prev"]')).click(e => {
      ...
      dots.forEach(dot => dot.classList.remove('active'));
      dots[slideIndex].classList.add('active');
    }); // Переключение слайдов по навигационным кнопкам
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-toggle="modal"]').modal(); // Создание модального окна
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(modal).addAttribute('id', this[i].getAttribute('data-target').slice(1)); // btns = {count: num, settings: [[text, classNames=[], close, cb]]}
    ...
    for (let j = 0; j < btns.count; j++) {
      ...
      if (btns.settings[j][2]) {
        Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(btn).addAttribute('data-close', 'true');
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");
 // Изменение HTML структуры в элементах на странице
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  ...
  return this;
}; // Получение соседних элементов, не включая сам элемент
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateOverTime = function (durection, callback, finaly) {
  let timeStart;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (durection, display, finaly) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOut = function (durection, finaly) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://jsonplaceholder.cypress.io/todos/1').then(res => {
  console.log(res);
});
